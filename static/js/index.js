	...
	$( document ).on( "mobileinit", function(){
		$.widget( "mobile.h2linker", $.mobile.widget, {
			...
			_create:function(){
				var self = this,
					bodyid = "ui-page-top",
					panel = "<div data-role='panel' class='jqm-nav-panel jqm-quicklink-panel' data-position='right' data-display='overlay' data-theme='c'><ul data-role='listview' data-inset='false' data-theme='d' data-divider-theme='d' data-icon='false' class='jqm-list'><li data-role='list-divider'>选择单元</li></ul></div>",
					first = true,
					...
					this.element.find("div.jqm-content>h2").each(function(){
						...
						if(!first){
							$(this).before( "<a href='#" + bodyid + "' class='jqm-deeplink ui-link'>回到顶部<span class='ui-icon ui-icon-arrow-u'>&nbsp;</span></a>");
						} else {
							$(this).before("<a href='#' data-ajax='false' class='jqm-deeplink ui-link jqm-open-quicklink-panel'>选择单元<span class='ui-icon ui-icon-bars'>&nbsp;</span></a>");
						}
						first = false;
					});
